...
class _$EmployeeImpl implements _Employee {
  ...
  @override
  String toString() {
    return 'Employee(uid: $uid, email: $email, name: $name, photoUrl: $photoUrl, dateOfBirth: $dateOfBirth, gender: $gender)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, uid, email, name, photoUrl, dateOfBirth, gender);
...
abstract class _Employee implements Employee {
  const factory _Employee(
      ...
      final String? photoUrl,
      final String? dateOfBirth,
      final String? gender}) = _$EmployeeImpl;
